...
pub struct ChatCompletionResponseJsonMode {
    ...
    pub choices: Option<Vec<models::ChatCompletionResponseJsonModeChoicesInner>>,
    #[serde(rename = "usage", skip_serializing_if = "Option::is_none")]
    pub usage: Option<models::JsonModeUsage>,
}

impl ChatCompletionResponseJsonMode {
    /// Creates a new `ChatCompletionResponseJsonMode` instance.
    ///
    /// # Arguments
    ///
    /// # Returns
    ///
    /// A new `ChatCompletionResponseJsonMode` instance.
    pub fn new() -> ChatCompletionResponseJsonMode {
