...
pub struct ChatCompletionRequestJsonMode {
    ...
    pub messages: Vec<models::JsonModeMessages>,
    #[serde(rename = "response_format", skip_serializing_if = "Option::is_none")]
    pub response_format: Option<models::JsonModeResponseFormat>,
...
impl ChatCompletionRequestJsonMode {
    /// Creates a new `ChatCompletionRequestJsonMode` instance.
    ///
    /// # Arguments
    /// * `model`
    /// * `messages`
    ...
    /// # Returns
    ///
    /// A new `ChatCompletionRequestJsonMode` instance.
    pub fn new(
        model: String,
        messages: Vec<models::JsonModeMessages>,
