...
java -jar /usr/local/bin/openapi-generator-cli.jar generate \
    ...
    -o $OUTPUT_DIR \
    --skip-validate-spec \
    --inline-schema-name-mappings  ChatCompletionResponseFunctionCall_choices_inner_message_tool_calls_inner=ChatCompletionResponseFnChoicesMessageTool,ChatCompletionResponse_usage=ChatCompletionResonseUsage,ChatCompletionResponseFunctionCall_choices_inner_message_tool_calls_inner_function=ChatCompletionFnTools,ChatCompletionResponseJSONMode_usage=ChatCompletionJsonModeUsage,ChatCompletionResponseJSONMode_choices_inner=ChatCompletionJsonModeChoices,ChatCompletionRequestFunctionCall_tools_inner=ChatCompletionTools,ChatCompletionRequestFunctionCall_tools_inner_function=ChatCompletionToolsFn,ChatCompletionResponseFunctionCall_choices_inner_message=ChatCompletionMessage,ChatCompletionResponseFunctionCall_choices_inner=ChatCompletionChoices,ChatCompletionResponseFunctionCall_usage=ChatCompletionUsage,FIMCompletionResponse_usage=FimCompletionResponseUsage,FIMCompletionResponse_choices_inner=FimCompletionChoices,FIMCompletionResponse_choices_inner_message=FimCompletionResponseMessages,EmbeddingResponse_usage=EmbeddingResponseUsage,EmbeddingResponse_data_inner=EmbeddingResponseData,ChatCompletionResponse_choices_inner=Choices,FIMCompletionRequest_stop=FimCompletionRequestStop,ChatCompletionRequestFunctionCall_messages_inner=ChatCompletionRequestFunctionCallMessages,ChatCompletionRequestJSONMode_response_format=JsonModeResponseFormat,ChatCompletionRequestJSONMode_messages_inner=JsonModeMessages,ChatCompletionRequest_messages_inner=ChatCompletionRequestMessages,jobs_api_routes_fine_tuning_create_fine_tuning_job_200_response=CreateFineTuningJobResponse200,createChatCompletion_200_response=ChatCompletionResponse200,ChatCompletionResponse_choices_inner_message=ChatCompletionChoices,ChatCompletionResponseJSONMode_choices_inner_message=JsonModeMessages,createChatCompletion_request=CreateChatRequest \
